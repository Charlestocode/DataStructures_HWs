public class HW02_4107054018_3 extends ThreeSum {
    
    public HW02_4107054018_3() { }
    ...
    public int T_sum(int[] arr) {
        ...
        for (int i = 0; i < arr.length - 1; i++) {  /* <=============== TEST HERE */
            left = i + 1;
            right = arr.length - 1;
    ...
    public static void main(String[] args) {
        ...
        HW02_4107054018_3 test = new HW02_4107054018_3();
